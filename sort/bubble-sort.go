...
/**
 * 1. 快速排序思想
 * 	  分解：将数组a[l...r] 划分成两个子数组，a[l...q-1], a[q+1...r]，使得a[l...q-1]中每个元素都小于等于a[q]，
 *		且a[q]小于等于a[q+1...r]中每个元素，其中，计算下标q也是划分过程中的一部分
 *    解决：通过递归调用快速排序，对子数组a[l...q-1]和a[q+1...r]进行排序
 *    合并：因为子数组都是原址排序的，所以不需要合并操作，a[l...r]已经有序
 *    上下文中提到的划分过程是：从子数组a[l...r]中选择任意一个元素x作为主元，
 *		调整子数组的元素使得左边的元素都小于它，右边的元素都大于它，x的最终位置就是q。
 */
